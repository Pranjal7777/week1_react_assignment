...
const Get_Data = () => async (dispatch) => {
    ...
    axios.get("https://assignmentreactjsonapi.herokuapp.com/add-city").then((res) => {
...
const AddCountry = (country) => async (dispatch) => {
    ...
    const res = await axios.post("https://assignmentreactjsonapi.herokuapp.com/add-country", {
        country
    }).catch((err) => {
...
const AddCity = (city_name, population, country_name) => async (dispatch) => {
    ...
    const res = await axios.post("https://assignmentreactjsonapi.herokuapp.com/add-city", {
        city_name,
        population,
        country_name
    }).catch((err) => {
